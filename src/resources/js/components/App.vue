            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-2xs">Add New</div>
                    </router-link>
                    <p class="pt-12 text-gray-500 uppercase text-xs font-bold">General</p>
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-2xs">Contacts</div>
                    </router-link>
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-2xs">Birthdays</div>
                    </router-link>
                    <p class="pt-12 text-gray-500 uppercase text-xs font-bold">Settings</p>
                    <router-link to="/" class="flex items-center py-2 hover:text-blue-600">
                        ...
                        <div class="tracking-wide pl-3 text-2xs">Logout</div>
                    </router-link>
                </nav>
            </div>
            <div>
