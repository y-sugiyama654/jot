    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div>
                    <router-link :to="'/contact/' + contact.contact_id + '/edit'" class="px-4 py-2 rounded text-sm text-green-500 border border-green-500 font-bold mr-2">Edit</router-link>
